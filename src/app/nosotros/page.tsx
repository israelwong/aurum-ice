        ...
        <div className="bg-gray-950 text-white">
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-300">En AURUM ICE creamos helados exclusivos, de alta calidad, hechos con ingredientes seleccionados y procesos responsables con el planeta.</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-16">
                    <div className="bg-gray-800 p-8 rounded-xl">
                        ...
                        <p className="text-gray-400">Buscamos deleitar a nuestros clientes con helados artesanales de alta calidad, hechos con ingredientes naturales y prácticas sustentables, promoviendo el consumo responsable y el respeto al medio ambiente.</p>
                    </div>
                    <div className="bg-gray-800 p-8 rounded-xl">
                        ...
                        <p className="text-gray-400">Ser la marca mexicana líder en helados artesanales, reconocida por su compromiso ambiental, sabor excepcional e innovación en productos saludables, fomentando una cultura de consumo consciente.</p>
                    </div>
                </div>
                ...
                <div className="text-center mb-16">
                    ...
                    <div
                        className="relative w-full max-w-4xl mx-auto aspect-video rounded-lg overflow-hidden border-2 border-gray-700 cursor-pointer hover:border-indigo-400 transition-all"
                ...
                <div className="bg-gray-800 p-8 md:p-12 rounded-2xl">
                    ...
                    <p className="text-gray-400 mb-6">Estamos comprometidos con el cuidado del planeta, por eso, hemos diseñado cada paso de nuestro proceso con responsabilidad ecológica cumpliendo las normativas ambientales mexicanas.</p>
